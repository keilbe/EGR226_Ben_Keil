...
*Course : EGR 226-905
*Date :  04/02/2021
*Project :  Lab 10 part 3 EC
*File :  lab 10 part 3 EC. c
*Description : LCD ACD temp sensor with pushbutton
**********************************************************************/
#include "msp432.h"
#include "stdio.h"
...
* Inputs: char line1, int k, int h, int j
* Outputs: char line1[], char line2[], int k, int j
*/
int main(void) {
    LCD_init();
    SysTick_Init ();
    ...
    while(1) {
        ...
        if ((!(P1IN & BUTTON_ONE))){           //true if button is pressed
            delay_ms (5);                 //five millisecond delay
